...
function today_stats(){
    ...
    .then(function (response) {
        ...
        text = JSON.parse(text)
        document.getElementById("dynamic_page").innerHTML="<div id='center_box'><p>Stat for the current day, "+text.current_date+": </p><p>Total Packets: "+text.packet_count+"</p><p>Total Records: "+text.record_count+"</p><p>Total Data: "+text.data_count+" "+text.data_unit+"</p></div>"
    })
}